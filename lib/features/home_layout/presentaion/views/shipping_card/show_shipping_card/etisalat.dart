...
class ShowEtisalatCard extends StatelessWidget {

  String newItem;
  ShowEtisalatCard(this.newItem);
  @override
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image.asset("assets/images/etisalat.png",width: 30.w,height: 13.h,color: Colors.white,),
                        ],
                      ),
