...
class ShowVodafoneCard extends StatelessWidget {

   String newItem;
   ShowVodafoneCard(this.newItem);
  @override
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image.asset("assets/images/vodafone2.png",width: 30.w,height: 13.h,color: Colors.white,),
                        ],
                      ),
