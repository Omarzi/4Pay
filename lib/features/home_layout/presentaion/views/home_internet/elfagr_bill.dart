...
class ElfagrBill extends StatefulWidget {
  String image;
  String text;

  ElfagrBill(this.image, this.text);

  @override
  State<ElfagrBill> createState() => _HomeInternetBillsState();
}

class _HomeInternetBillsState extends State<ElfagrBill> {
  @override
  List<String> list = [
