...
class HomeInternetBills extends StatefulWidget {
  String image;
  String text;

  HomeInternetBills(this.image, this.text);

  @override
  State<HomeInternetBills> createState() => _HomeInternetBillsState();
}

class _HomeInternetBillsState extends State<HomeInternetBills> {
  @override
  List<String> list = [
    "orange Package 10",
    "orange Package 20",
