...
class HomeInternetWe extends StatefulWidget {
  String image;
  String text;

  HomeInternetWe(this.image, this.text);

  @override
  State<HomeInternetWe> createState() => _HomeInternetBillsState();
}

class _HomeInternetBillsState extends State<HomeInternetWe> {
  @override
  List<String> list = [
    "orange Package 10",
    "orange Package 20",
