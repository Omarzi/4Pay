...
class EtisalatDsl extends StatefulWidget {
  String image;
  String text;

  EtisalatDsl(this.image, this.text);

  @override
  State<EtisalatDsl> createState() => _HomeInternetBillsState();
}

class _HomeInternetBillsState extends State<EtisalatDsl> {
  @override
  List<String> list = [
