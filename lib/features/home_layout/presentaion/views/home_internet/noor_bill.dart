...
class NoorBill extends StatefulWidget {
  String image;
  String text;

  NoorBill(this.image, this.text);

  @override
  State<NoorBill> createState() => _HomeInternetBillsState();
}

class _HomeInternetBillsState extends State<NoorBill> {
  @override
  List<String> list = [
