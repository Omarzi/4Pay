...
class MobillBillEgypt extends StatefulWidget {
  String image;
  String text;

  MobillBillEgypt(this.image, this.text);

  @override
  State<MobillBillEgypt> createState() => _HomeInternetBillsState();
}

class _HomeInternetBillsState extends State<MobillBillEgypt> {
  @override
  // Option 2
  String? selectItem;
  String? newf;
