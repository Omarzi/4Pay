...
class MobileBillVodafone extends StatefulWidget {
  String image;
  String text;

  MobileBillVodafone(this.image, this.text);

  @override
  State<MobileBillVodafone> createState() => _HomeInternetBillsState();
}

class _HomeInternetBillsState extends State<MobileBillVodafone> {
  @override
  List<String> list = [
