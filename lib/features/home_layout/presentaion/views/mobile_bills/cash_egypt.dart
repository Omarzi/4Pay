...
class CashEgypt extends StatefulWidget {
  String image;
  String text;

  CashEgypt(this.image, this.text);

  @override
  State<CashEgypt> createState() => _HomeInternetBillsState();
}

class _HomeInternetBillsState extends State<CashEgypt> {
  @override
  // Option 2
  String? selectItem;
  String? newf;
