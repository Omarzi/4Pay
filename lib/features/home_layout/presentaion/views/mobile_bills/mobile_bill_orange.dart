...
class MobileBillOrange extends StatefulWidget {
  String image;
  String text;

  MobileBillOrange(this.image, this.text);

  @override
  State<MobileBillOrange> createState() => _HomeInternetBillsState();
}

class _HomeInternetBillsState extends State<MobileBillOrange> {
  @override
  // Option 2
  String? selectItem;
  String? newf;
