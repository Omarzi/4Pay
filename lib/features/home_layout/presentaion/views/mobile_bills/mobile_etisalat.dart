...
class MobillEtisalat extends StatefulWidget {
  String image;
  String text;

  MobillEtisalat(this.image, this.text);

  @override
  State<MobillEtisalat> createState() => _HomeInternetBillsState();
}

class _HomeInternetBillsState extends State<MobillEtisalat> {
  @override
  // Option 2
  String? selectItem;
  String? newf;
