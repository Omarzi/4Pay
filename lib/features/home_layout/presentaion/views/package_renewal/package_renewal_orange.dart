...
class PackageRenewalOrange extends StatefulWidget {

  @override
  State<PackageRenewalOrange> createState() => _ShippingCardVodafoneState();
}

class _ShippingCardVodafoneState extends State<PackageRenewalOrange> {
        ...
        child: Column(
          children: [
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                Image.asset(
                  "assets/images/orange.png", width: 57.w, height: 20.h,),
              ],
            ),
            Directionality(
              textDirection: TextDirection.rtl,
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        suffixIcon: GestureDetector(
                            ...
                            setState(() {
                              _contact = contact;
                              _contactPhone.text=_contact!.phoneNumbers!.first;
                            print("2222222222");
                            });
                            },
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Column(mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Image.asset("assets/images/orange.png", width: 25.w,
                          height: 10.h,),
                        Directionality(
                          textDirection: TextDirection.rtl,
