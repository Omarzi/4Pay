...
class PackageRenewalWe extends StatefulWidget {

  @override
  State<PackageRenewalWe> createState() => _ShippingCardVodafoneState();
}

class _ShippingCardVodafoneState extends State<PackageRenewalWe> {
        ...
        child: Column(
          children: [
            Row(crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                Image.asset(
                  "assets/images/we.png", width: 57.w, height: 20.h,),
              ],
            ),
            Directionality(
              textDirection: TextDirection.rtl,
